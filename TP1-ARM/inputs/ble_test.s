.text
// Test BLE (Branch if Less or Equal) instruction
...
// Branch if less or equal (should branch)
BLE label1
...
MOVZ X9, #20     // X9 = 20
MOVZ X10, #10    // X10 = 10 (less than X9)

// Compare X9 and X10 (X9 > X10)
CMP X9, X10

// Branch if less or equal (should not branch)
BLE label3
